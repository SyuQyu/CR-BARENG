        ...
        >
            <div className="max-w-[1440px] sm:py-16 py-8 sm:px-8 lg:px-16 w-full flex sm:flex-row flex-col-reverse gap-5">
                <div className={`flex w-full flex-col gap-5 ${contentAlignment} ${marginTop} text-white ${contentClassName}`}>
                    ...
                    <h1 className={`text-mobile-heading-1 md:text-mobile-heading-1 lg:text-desktop-heading-1 font-bold bg-clip-text relative ${textAlignment} z-20 w-full sm:w-[70%]`}>
                        {title}
                    </h1>
                    <p className={`sm:text-desktop-body-1 text-mobile-body-1 sm:w-[80%] w-full ${textAlignment}`}>
                        {description}
                    </p>
                </div>
            </div>
