...
const HeroCard: React.FC<HeroCardProps> = ({ link, rounded = true, imageUrl, imageAlt, date, border, title, description, imagePosition = "left", dateTextColor = "text-custom-gray-cr", titleTextColor = "text-primary-cr-600", descriptionTextColor, linkText}) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-2 justify-start items-start">
                ...
                {
                    link && (
                        <Link href={link} className="flex flex-row justify-start items-center gap-2 text-desktop-body-2 text-primary-cr-700"> {linkText} <svg className="mt-1" xmlns="http://www.w3.org/2000/svg" width="19" height="13" viewBox="0 0 19 13" fill="none">
