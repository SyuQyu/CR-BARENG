      ...
      <div className="w-full mb-10 flex flex-col justify-start items-start max-w-[1440px] gap-8 px-6 lg:px-8">
        ...
        <div className="w-full flex sm:flex-row flex-col-reverse justify-between items-start border-t border-b border-slate-500/20 py-8 gap-6 sm:gap-20">
            ...
            <div className="w-full flex flex-row sm:justify-start justify-center items-center gap-3">
              ...
              >
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_4842_8226)">
                    <path
              ...
              >
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_4842_8231)">
                    <path
                    ...
                    />
                    <path
                      d="M11.1333 10.4449L11.5823 8.00007H8.96916V7.13543C8.96916 5.84359 9.47604 5.34663 10.7877 5.34663C11.1951 5.34663 11.5231 5.35655 11.7119 5.37639V3.16039C11.3541 3.06087 10.4796 2.96167 9.97268 2.96167C7.2994 2.96167 6.06708 4.22375 6.06708 6.94663V8.00007H4.41748V10.4449H6.06708V15.7646C6.68596 15.9181 7.33332 16.0001 7.99956 16.0001C8.32756 16.0001 8.65108 15.9799 8.96884 15.9415V10.4449H11.133H11.1333Z"
                      fill="white"
                    />
                  </g>
                  <defs>
              ...
              >
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_4842_8243)">
                    <path
                    ...
                    />
                    <path
                      d="M13.2312 3.72818C13.2312 4.25943 12.8 4.68755 12.2719 4.68755C11.7406 4.68755 11.3125 4.2563 11.3125 3.72818C11.3125 3.19692 11.7438 2.7688 12.2719 2.7688C12.8 2.7688 13.2312 3.20005 13.2312 3.72818Z"
                      fill="#453CFF"
                    />
                  </g>
                  <defs>
          ...
          <div className="w-full lg:grid-cols-4 min-[400px]:grid-cols-2 grid-cols-1 items-start gap-1 hidden sm:grid">
            {footerData?.map((product: any, index: number) => (
              <div
                key={index}
                className="flex flex-col gap-1.5 min-[400px]:justify-start justify-center items-center min-[400px]:items-start"
              >
                <p className="font-semibold text-desktop-body-2 min-[400px]:text-left text-center">
                  {product.title}
                </p>
                {product.links.map((link: string, idx: number) => (
                  <Link
                    key={idx}
                    className="text-neutral-500 text-desktop-label-l min-[400px]:text-left text-center"
                    href={""}
                  >
                    {link}
                  </Link>
                ...
                >
                  ...
                  <AccordionContent className="flex flex-col gap-2 justify-start items-start">
                    {product.links.map((link: any, idx: number) => (
                      <Link
                        key={idx}
                        className="text-neutral-500 text-desktop-label-l"
                        href={""}
                      >
                        {link}
                      </Link>
        ...
        <div className="w-full flex flex-col sm:flex-row gap-4 justify-center sm:justify-between items-center">
          <ImageWithFallback
            ...
            alt="logo"
          />
          <p className="md:text-desktop-body-2 text-desktop-body-3 text-neutral-500 font-semibold">
            © 2025, 
            <span className="underline text-primary-cr-500 font-bold">
              CrescentRating
            </span>
            . All rights reserved.
          </p>
