  ...
  return (
    <footer className={clsx(className)}>
      <div className="w-[50%] flex flex-col justify-center items-center p-10 gap-8 text-white">
        <p className="text-3xl font-bold">Subscribe to our newsletters</p>
        <form className="rounded-full w-full max-w-[700px] flex flex-row">
          <input
            placeholder="email@example.com"
            className="rounded-l-full !text-black text-inherit w-full px-4 py-4 mr-[-1px] border-0 transition-all duration-200 focus:outline-none"
          />
          <button
            type="button"
            className="rounded-r-full text-inherit float-right px-4 py-4 ml-[-1px] bg-[#f4a01c] transition-all duration-200 border-0 hover:cursor-pointer hover:px-6"
          >
            Submit
          </button>
        </form>
        <div className="flex flex-row items-center justify-start">
          ...
          <p className="text-sm">
            ...
            <span className="text-custom-blue font-bold">Privacy Policy</span> &{" "}
