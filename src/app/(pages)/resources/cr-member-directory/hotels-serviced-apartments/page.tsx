...
export default function CertifiedProfessionalsDirectoryPage() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <PageHero
        title="Crescent Rated Hotels & Serviced Apartments"
        description="Explore trusted Hotels & Serviced Apartments that meet CrescentRating's halal-friendly standards."
        subtitle="Resources"
