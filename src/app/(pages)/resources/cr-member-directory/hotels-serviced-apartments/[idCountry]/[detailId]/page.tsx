...
import {
  detailCrMemberDirectoryHotelsImg,
  halalFriendlyFacilitiesCrMemberDirectory,
...
export default function CertifiedProfessionalsDirectoryPage() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="w-full lg:px-32 sm:px-16 px-16 mt-16">
        <BreadCrumb variant="light" />
      </div>
      <section className="mt-7 sm:mt-14 px-16 lg:px-32 w-full flex flex-col gap-8 justify-center items-center max-w-[1440px]">
          ...
          <div className=" w-full h-full border p-4">
            <div className="grid grid-cols-1 md:grid-cols-3 w-full h-full gap-4 justify-center items-center p-4">
              ...
              <div className="grid grid-cols-2 w-full gap-4 relative">
                ...
                <div className="absolute md:bottom-4 bottom-2 w-auto md:right-4 right-2 flex items-center justify-center">
                  <Button
                    variant="secondary"
                    onClick={() => handleImageClick(0)}
                  >
            ...
            <div className="flex flex-col gap-2 w-full h-full">
              ...
              <div className="flex md:flex-row flex-col justify-between items-center w-full h-full">
                <div className="md:block w-full h-full flex flex-row justify-between items-center">
                  <p className="md:text-desktop-heading-4 text-mobile-heading-3 font-bold w-full md:w-[50%]">
        ...
        <section className="px-6 lg:px-8 w-full flex flex-col justify-center items-center">
          <div className="flex sm:flex-row flex-col justify-center items-start w-full gap-1">
            <div className="w-full">
              <Tabs
                mobileMode="tabs"
                isMobile={false}
                defaultValue="halal-friendly-facilities"
                className="w-full"
              >
                <TabsList className="w-full max-w-[1440px] lg:overflow-hidden overflow-x-scroll !border-none">
                  {[
                    {
                      value: "halal-friendly-facilities",
                      label: "Halal Friendly Facilities",
                    },
          ...
          {/* SECTION CONTENTS */}
          <div
            id="halal-friendly-facilities"
            className={clsx(
              "my-4 md:my-8 p-4 md:p-5 w-full rounded-sm scroll-mt-20",
              selectedCategory === "halal-friendly-facilities"
                ? "border border-primary-cr-500"
                : null
            )}
          >
            <div className="w-full flex flex-col gap-5 justify-start items-start">
              <p className="text-mobile-heading-4 md:text-desktop-heading-6 font-semibold">
                Halal Friendly Facilities
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                {halalFriendlyFacilitiesCrMemberDirectory.map(
                  (facility, index) => (
                    <div
                      key={index}
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1">
                        <p className="sm:text-desktop-body-2 text-mobile-body-3 font-semibold">
                          {facility.title}
                        </p>
                        <div className="flex flex-col gap-1">
                          {facility.descriptions.map(
                            (description, descIndex) => (
                              <p
                                key={descIndex}
                                className="sm:text-desktop-body-2 text-mobile-body-3 text-gray-500"
                              >
                                {description}
                              </p>
                            )
          ...
          >
            <p className="text-mobile-heading-4 md:text-desktop-heading-6 font-semibold mb-5">
              About
            </p>
            <p className="md:text-desktop-body-2 text-mobile-body-3">
              The Park Lane Hong Kong, Autograph Collection is a contemporary
              oasis tailored for the discerning traveler of the 21st century.
              With its sophisticated design, attentive service, and breathtaking
              views of the harbor, Victoria Park, and the Kowloon skyline, the
              hotel serves as the ultimate sanctuary for modern urban nomads.
              Located on Hong Kong Island, the hotel offers convenient access to
              nearby mosques and halal-certified restaurants, as well as the
              city’s finest shopping and entertainment options. As a
              Muslim-friendly hotel, we provide Qibla directions in rooms along
              with prayer mat, Mosques Direction Card and Halal breakfast corner
              at Ebb & Flow. Whether you are traveling for business or leisure,
              The Park Lane Hong Kong, Autograph Collection is the perfect
              destination for an unforgettable stay in Hong Kong.
            </p>
          </div>
