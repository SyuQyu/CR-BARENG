...
export default function Submission() {
    return (
        <div className="w-full flex flex-col justify-center items-center">
            ...
            >
                <div className="max-w-[1440px] sm:py-16 py-8 lg:px-32 sm:px-16 px-8 w-full flex sm:flex-row flex-col-reverse gap-5 ">
            ...
            <div className='mt-16 lg:px-64 sm:px-16 px-8 w-full flex flex-col gap-24 justify-center items-center'>
                <div className="max-w-[1440px] w-full flex flex-col justify-center items-center">
                    ...
                    <div className="mt-10 flex flex-col justify-center items-center w-full gap-6">
                        <div className="w-full flex flex-col justify-center items-center bg-neutral-100 p-8 gap-8">
                            ...
                            <Button variant="primary" className="w-full py-2">Submit</Button>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-[1440px] lg:px-32 sm:px-16 px-8 w-full flex flex-col justify-center items-center">
                    ...
                    <div className="mt-5 flex flex-col justify-center items-center w-full gap-6">
                        <Button variant="primary" className="px-8 py-4">Contact Us</Button>
                    </div>
                </div>
            </div>
        </div>
