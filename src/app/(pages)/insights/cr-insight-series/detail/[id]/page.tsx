...
export default function CRInsightSeriesDetail() {
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center">
            <section
                className="mt-16 relative w-full lg:px-8 px-6 md:p-0 max-w-[1440px] p-4 flex sm:flex-row flex-col-reverse gap-5 justify-center items-center bg-center"
            >
                <div className="flex w-full max-w-[1440px] sm:py-16 py-8 md:px-6 lg:px-0 flex-col gap-4 justify-start items-start">
                    ...
                    <p className="text-neutral-500 text-left text-mobile-body-3 md:text-mobile-body-2 lg:text-desktop-body-2 relative z-20 max-w-4xl">
                        A series of developed thought processes and theories, crystalized info frameworks, that seek to better examine Halal travel, these models range from assisting the industry in identifying its objectives to building competences, and better understanding the motivations of Muslim travelers and how best to serve them.
                    </p>
