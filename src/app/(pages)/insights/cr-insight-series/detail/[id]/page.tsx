...
import { reportsInsightSeries } from "@/constants/dummyData";
import BreadCrumb from "@/components/common/breadcrumb/breadcrumb";

export default function CRInsightSeriesDetail() {
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="w-full max-w-[1440px] lg:px-32 sm:px-16 px-8 mt-16">
        <BreadCrumb variant="light" excludeSegment="detail" />
      </div>
      <section className="mt-16 relative w-full lg:px-32 sm:px-16 px-8 max-w-[1440px] p-4 flex sm:flex-row flex-col-reverse gap-5 justify-center items-center bg-center">
        <div className="flex w-full max-w-[1440px] sm:py-16 py-8 md:px-6 lg:px-0 flex-col gap-4 justify-start items-start">
          ...
          <p className="text-neutral-500 text-left text-mobile-body-3 md:text-mobile-body-2 lg:text-desktop-body-2 relative z-20 max-w-4xl">
            A series of developed thought processes and theories, crystalized
            info frameworks, that seek to better examine Halal travel, these
            models range from assisting the industry in identifying its
            objectives to building competences, and better understanding the
            motivations of Muslim travelers and how best to serve them.
          </p>
          <div className="flex sm:flex-row flex-col justify-start gap-4 items-center w-full">
            <Dialog>
              <DialogTrigger className="flex flex-row justify-center items-center gap-2 text-white bg-blue-600 sm:p-4 p-3 w-full sm:max-w-[200px] lg:text-mobile-body-1 text-mobile-body-3">
              ...
              <DialogContent className="w-full max-w-[919px] flex flex-row justify-between items-center gap-4 p-6">
                <div className="flex flex-col gap-2 justify-start items-start w-full md:w-[50%]">
                  <p className="md:text-desktop-heading-5 text-mobile-heading-5 font-bold">
                    One more step!
                  </p>
                  <p className="md:text-desktop-body-2 text-mobile-body-2 text-gray-600">
                    Please fill in your information to access this publication.
                    Your details help us personalize your experience and keep
                    you updated with the latest insights from CrescentRating.
                  </p>
                  <div className="mt-4 w-full flex flex-col gap-4">
                    <div className="w-full flex flex-col justify-start items-start gap-1">
                      <p className="md:text-desktop-label-l text-desktop-label-s font-bold">
                        Name
                      </p>
                      <Input
                    ...
                    <Button
                      variant="primary"
                      className="bg-custom-purple-cr w-full"
                    >
                  ...
                  <li>
                    ...
                    >
                      ...
                      <svg
                        ...
                        fill="none"
                      >
                        <g clipPath="url(#clip0_3899_7942)">
                          <path
                  ...
                  <li>
                    ...
                    >
                      ...
                      <svg
                        ...
                        fill="none"
                      >
                        <g clipPath="url(#clip0_3899_7956)">
                          <path
