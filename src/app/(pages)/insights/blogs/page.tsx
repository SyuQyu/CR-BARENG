  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <PageHero
        ...
        variant="image"
      />
      <section className="mt-16 lg:px-32 sm:px-16 px-8 w-full flex flex-col gap-24 justify-center items-center">
        <section className="max-w-[1440px] px-6 lg:px-8 w-full flex flex-col justify-center items-center">
          ...
          <p className="sm:text-desktop-body-2 text-mobile-body-2 text-center text-gray-500 w-[80%] lg:w-[50%]">
            Stay Updated with the Latest Insights on Halal Travel
          </p>
              ...
              <div className="flex flex-col justify-start items-start">
                ...
                <div className="flex flex-col gap-2 justify-start items-start w-full">
                  ...
                  <p className="sm:text-desktop-body-2 text-mobile-body-2">
                    Lorem ipsum dolor sit amet consectetur. Molestie interdum
                    tellus enim quis feugiat. Nisl et placerat turpis tortor
                    nec. Egestas magnis donec varius nunc purus rutrum rutrum
                    nisi.
                  </p>
                </div>
              </div>
        ...
        <section className="max-w-[1440px] px-6 lg:px-8 w-full flex flex-col justify-start items-start">
          <div className="flex flex-row justify-between items-center w-full">
            <div className="w-full flex flex-col">
              <p className="sm:text-desktop-heading-4 text-mobile-heading-4 font-bold mb-4 bg-clip-text text-black text-start w-[80%] lg:w-[35%]">
                All Releases
              </p>
              <p className="sm:text-desktop-body-2 text-mobile-body-2 text-start text-gray-500 w-[80%] lg:w-[50%]">
                Explore Halal Travel Topics Tailored to Your Interests
              </p>
            </div>
            <div className="flex flex-row justify-start items-center w-[40%]">
              ...
              <Button
                ...
                className="flex flex-row justify-center items-center gap-2 text-white bg-[#453CFF] h-12 px-4"
              >
                Search
              </Button>
            </div>
          ...
          <div className="mt-10 flex sm:flex-row flex-col justify-center items-start w-full gap-1">
            <Tabs defaultValue="all" className="w-full">
              ...
              {filteredData.map((tab) => (
                ...
                >
                  <div className="grid md:grid-cols-3 gap-4 w-full mb-12">
                    {tab?.media?.length > 0 ? (
        ...
        <section className="max-w-[1440px] px-6 lg:px-8 w-full flex flex-col justify-center items-center">
          ...
          <p className="sm:text-desktop-body-2 text-mobile-body-2 text-center text-gray-500 w-[80%] lg:w-[50%]">
            Discover Insights from Our Top Authors
          </p>
          <div className="mt-10 flex sm:flex-row flex-col justify-center items-start w-full gap-1">
            <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 justify-between items-start gap-6 w-full">
              {authorsBlogs.map((author, index) => (
                <div
                  key={index}
                  className="w-full flex h-full flex-row justify-start items-stretch gap-3 border p-2"
                >
                  <ImageWithFallback
                    width={0}
                    height={0}
                  ...
                  <div className="w-full flex flex-col justify-start items-start">
                    <p className="font-bold text-desktop-body-2">
                      {author.name}
                    </p>
                    <p className="text-gray-500 text-desktop-caption-s mb-2">
                      {author.articles} Articles
                    </p>
                    <Link
                      href={`/insights/blogs/author/${author.name}`}
                      className="flex flex-row justify-start items-center gap-1 text-desktop-body-3 text-primary-cr-700 font-semibold"
                    >
                      {" "}
                      See All <ArrowRight className="size-4 mt-[2px]" />{" "}
                    </Link>
                  </div>
                </div>
              ))}
          ...
          <Button variant="primary" className="px-6 py-4 mt-6">
            See More
          </Button>
        </section>
        <section
