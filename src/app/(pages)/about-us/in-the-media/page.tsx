"use client";
import { CardReports, Pagination, PageHero } from "@/components/common";
...
export default function InTheMediaPage() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <PageHero
        title="In the Media"
        description="Media coverage and reports on CrescentRating and Halal/Muslim Travel Market"
        subtitle="About Us"
        backgroundImage="/image/in-the-media/hero.jpg"
        alignment="left"
        variant="image"
      />
