      ...
      <div className="mt-7 sm:mt-14 w-full flex flex-col gap-24 justify-center items-center">
        <div className="max-w-[1440px] px-6 lg:px-8 w-full flex flex-col justify-center items-center">
          <p className="lg:text-desktop-body-1 text-mobile-body-1 text-left w-full text-neutral-500">
            ...
            halal-friendly travel. The company uses insight, industry
            intelligence, lifestyle, behavior, and research on the needs of the
            Muslim traveler to deliver authoritative guidance on all aspects of
            halal-friendly travel to organizations across the globe. The primary
            aim of CrescentRating is to enable Muslim travelers to explore the
            world with peace of mind so that it can benefit Travelers, Travel
            Service providers, our Stakeholders, and the Community as a whole.
            Our Commitment is to be the Credible, Knowledgeable, and Globally
            Trusted brand for Halal/Muslim friendly Travel.
          </p>
          <div className="mt-10 flex sm:flex-row flex-col justify-center p-8 items-start w-full gap-6 bg-neutral-100">
            <div className="w-full flex flex-col justify-center items-center gap-2">
              <p className="lg:text-desktop-heading-4 text-mobile-heading-4 font-bold mb-4 bg-clip-text text-primary-cr-600 text-left w-full">
                Our Vision
              </p>
              <p className="lg:text-desktop-body-1 text-mobile-body-1 text-left w-full text-neutral-500">
                A world where Muslims can explore the world around them with
                ease while building bridges with all communities.
              </p>
            </div>
            ...
            <div className="w-full flex flex-col justify-center items-center gap-2">
              ...
              <p className="lg:text-desktop-body-1 text-mobile-body-1 text-left w-full text-neutral-500">
                Dedicated to nurturing a thriving, sustainable Halal Travel
                ecosystem. Our mission is to foster collaboration, and
                innovation in the Halal Travel industry, promote destinations &
                businesses, facilitate trade, and honor excellence within this
                dynamic sector.
              </p>
            </div>
          </div>
          ...
          {openTeam ? (
            <>
              <div className="flex flex-row justify-between items-center gap-6">
                <p className="lg:text-desktop-heading-5 text-mobile-heading-4 font-bold mb-4 bg-clip-text text-black text-left">
                  Our Team
                </p>
                <Button
                  onClick={() => {
                      ...
                      <CarouselItem key={member.name} className="md:px-16 px-4">
                        <div className="flex flex-col md:flex-row justify-start items-start w-full gap-6 mt-10">
                          ...
                          <div className="flex flex-col justify-center items-start gap-2">
                            <h2 className="text-mobile-body-2 md:text-desktop-body-2 text-blue-600">
                              {teamName.replace(/-/g, " ").toUpperCase()}
                            </h2>
                            <p className="text-mobile-heading-2 md:text-desktop-heading-4 font-bold">
                              {member.name}
                            </p>
                            ...
                            <p className="text-mobile-body-2 md:text-desktop-body-2 text-neutral-500">
                              ...
                              elit. Cumque accusamus perspiciatis labore ad
                              quidem. Laudantium delectus officiis, veniam modi
                              distinctio incidunt reiciendis nesciunt veritatis,
                              voluptatibus, quasi est in iure corporis.
                            </p>
                            <a
                              href="#"
            ...
            <>
              <p className="sm:text-desktop-heading-4 text-mobile-heading-4 font-bold mb-4 bg-clip-text text-black text-center">
                Dedicated Experts in Halal Travel
              </p>
              <p className="sm:text-desktop-body-2 text-mobile-body-2 text-center text-neutral-500">
                Our team is made up of industry specialists and passionate
                advocates for Muslim-friendly travel.
              </p>
              <div className="mt-10 flex justify-center items-center w-full">
                <Tabs defaultValue="executive-management" className="w-full">
                  <TabsList className="w-full max-w-[1440px] lg:overflow-hidden overflow-x-scroll !border-none">
                    ...
                    <TabsTrigger className="w-full" value="business-events">
                      Business & Events
                    </TabsTrigger>
                  </TabsList>
                  {Object.entries(teamDataAboutUs).map(
                    ([key, members]: any) => (
                      <TabsContent
                        key={key}
                        value={key}
                          ...
                          {members.map((member: any, index: number) => (
                            ...
                            >
                              ...
                              <div className="w-full flex flex-col justify-start items-start">
                                <h3 className="md:text-desktop-body-1 text-mobile-body-1 font-semibold mt-4">
                                  {member.name}
                                </h3>
                                <p className="text-neutral-500 md:text-desktop-caption-l text-mobile-caption-l">
                                  {member.role}
                                </p>
                              </div>
                            </div>
        ...
        <div className="max-w-[1440px] px-6 lg:px-8 w-full flex flex-col justify-center items-center">
          ...
          <p className="sm:text-desktop-body-2 text-mobile-body-2 text-center text-neutral-500 w-[80%] lg:w-[50%]">
            We&apos;re proud to work with top partners and clients worldwide,
          ...
          <div className="mt-10 flex md:flex-row flex-col justify-center items-center w-full gap-6">
            <div className="w-full flex flex-col justify-center items-center gap-.5">
              <p className="lg:text-desktop-heading-6 text-mobile-heading-4 font-bold mb-4 bg-clip-text text-left w-full">
                Global Partners
              </p>
              <ImageWithFallback
                width={0}
        ...
        <div className="max-w-[1440px] px-6 lg:px-8 w-full flex flex-col justify-center items-start">
          <p className="sm:text-desktop-heading-4 text-mobile-heading-4 font-bold mb-4 bg-clip-text text-black text-left">
            Recognized for Excellence in Halal Tourism
          </p>
          <p className="sm:text-desktop-body-2 text-mobile-body-2 text-left text-neutral-500 w-[80%] lg:w-[50%]">
