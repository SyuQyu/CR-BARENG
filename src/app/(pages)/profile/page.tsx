  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      ...
      <div className="my-7 sm:my-14 w-full flex flex-col gap-24 justify-center items-center">
        <section className="max-w-[1440px] lg:px-32 sm:px-16 px-8 w-full flex flex-col justify-center items-center">
                ...
                <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                  ...
                  <div className="w-full flex sm:flex-row flex-col justify-start items-start gap-12">
                    <div className="w-full sm:w-[25%] flex flex-col gap-2">
                      <p className="text-desktop-label-l font-semibold">
                        Profile Image
                      </p>
                      <div className="rounded-full size-[160px] relative bg-neutral-100 p-10 group">
                        ...
                        <label
                          ...
                          className="absolute bottom-0 right-0 bg-primary-cr-700 rounded-full p-3 cursor-pointer hover:bg-primary-cr-800 transition-colors z-20"
                        >
                          <svg
                          ...
                          >
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M10.0002 7.5C8.15921 7.5 6.66683 8.99238 6.66683 10.8333C6.66683 12.6743 8.15921 14.1667 10.0002 14.1667C11.8411 14.1667 13.3335 12.6743 13.3335 10.8333C13.3335 8.99238 11.8411 7.5 10.0002 7.5ZM8.3335 10.8333C8.3335 9.91286 9.07969 9.16667 10.0002 9.16667C10.9206 9.16667 11.6668 9.91286 11.6668 10.8333C11.6668 11.7538 10.9206 12.5 10.0002 12.5C9.07969 12.5 8.3335 11.7538 8.3335 10.8333Z"
                              fill="white"
                            />
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M8.3335 2.5C6.95278 2.5 5.8335 3.61929 5.8335 5H3.3335C1.95278 5 0.833496 6.11929 0.833496 7.5V15C0.833496 16.3807 1.95278 17.5 3.3335 17.5H16.6668C18.0475 17.5 19.1668 16.3807 19.1668 15V7.5C19.1668 6.11929 18.0475 5 16.6668 5H14.1668C14.1668 3.61929 13.0475 2.5 11.6668 2.5H8.3335ZM7.50016 5C7.50016 4.53976 7.87326 4.16667 8.3335 4.16667H11.6668C12.1271 4.16667 12.5002 4.53976 12.5002 5V5.83333C12.5002 6.29357 12.8733 6.66667 13.3335 6.66667H16.6668C17.1271 6.66667 17.5002 7.03976 17.5002 7.5V15C17.5002 15.4602 17.1271 15.8333 16.6668 15.8333H3.3335C2.87326 15.8333 2.50016 15.4602 2.50016 15V7.5C2.50016 7.03976 2.87326 6.66667 3.3335 6.66667H6.66683C7.12707 6.66667 7.50016 6.29357 7.50016 5.83333V5Z"
                              fill="white"
                            />
                          </svg>
                        </label>
              ...
              >
                <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                  <div className="flex flex-col w-full">
                    ...
                    <p className="md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Manage and register your hotel properties.
                    </p>
                  </div>
                    ...
                    <div className="flex flex-col w-full justify-center items-center p-6">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M11.1667 5.89575C11.0152 5.90865 10.8694 5.92422 10.7296 5.94302C9.85559 6.06053 9.01779 6.32552 8.33824 7.00507C7.65869 7.68462 7.3937 8.52242 7.27619 9.39644C7.16654 10.212 7.1666 11.2304 7.16666 12.4124L7.16667 28.5002H4.5V31.1668H28.5V28.5002H25.8333L25.8333 12.4124C25.8334 11.2304 25.8335 10.212 25.7238 9.39644C25.6063 8.52242 25.3413 7.68462 24.6618 7.00507C23.9822 6.32552 23.1444 6.06053 22.2704 5.94302C21.4548 5.83337 20.4364 5.83343 19.2544 5.83349L19.1667 5.8335V3.16683H16.5V5.8335H13.8333V1.8335H11.1667V5.89575ZM23.1667 28.5002V12.5002C23.1667 11.2054 23.1638 10.3684 23.0809 9.75177C23.0032 9.17345 22.8776 8.99219 22.7761 8.89069C22.6746 8.78919 22.4934 8.66366 21.9151 8.5859C21.2984 8.50299 20.4614 8.50016 19.1667 8.50016H13.8333C12.5386 8.50016 11.7016 8.50299 11.0849 8.5859C10.5066 8.66366 10.3254 8.78919 10.2239 8.89069C10.1224 8.99219 9.99683 9.17345 9.91908 9.75177C9.83617 10.3684 9.83333 11.2054 9.83333 12.5002V28.5002H23.1667ZM13.8333 13.8335H11.1667V11.1668H13.8333V13.8335ZM21.8333 13.8335H19.1667V11.1668H21.8333V13.8335ZM11.1667 19.1668V16.5002H13.8333V19.1668H11.1667ZM15.1667 13.8335V11.1668H17.8333V13.8335H15.1667ZM15.1667 19.1668V16.5002H17.8333V19.1668H15.1667ZM19.1667 19.1668V16.5002H21.8333V19.1668H19.1667ZM11.1667 24.5002V21.8335H13.8333V24.5002H11.1667ZM15.1667 24.5002V21.8335H17.8333V24.5002H15.1667ZM19.1667 24.5002V21.8335H21.8333V24.5002H19.1667Z"
                          fill="#E3E2E6"
                        />
                      </svg>
                      <p className="text-center md:text-desktop-body-2 text-mobile-body-2 font-bold mt-4">
                        No Hotels Registered Yet
                      </p>
                      <p className="text-center md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                        Get started by registering your first property for
                        CrescentRating’s halal-friendly hotel accreditation.
                      </p>
                      <p className="text-center md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                        Accreditation with CrescentRating positions your hotel
                        as a trusted choice for Muslim travelers worldwide. Join
                        hospitality leaders committed to serving a growing
                        global market with confidence and credibility.
                      </p>
                    ...
                    <div className="w-full flex flex-col gap-4">
                      ...
                      <div className="w-full grid md:grid-cols-3 grid-cols-1 gap-4">
                        {dataRegisteredHotelUser.map((hotel, index) => (
                          <div
                            key={index}
                            className="border border-[#E3E2E6] p-4 flex flex-col gap-3 bg-white"
                          >
                            <ImageWithFallback
                              width={0}
                              height={0}
                              ...
                              alt="Hotel ABC 123"
                            />
                            <p className="text-desktop-label-l font-semibold mt-2">
                              {hotel?.name}
                            </p>
                            {/* Optional: Location */}
              ...
              >
                <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                  <div className="flex flex-col w-full">
                    ...
                    <p className="md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Manage and register your restaurants properties.
                    </p>
                  </div>
                  <div className="flex flex-col w-full justify-center items-center p-6">
                    <svg
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M25.1663 2.6665C22.589 2.6665 20.4997 4.75584 20.4997 7.33317C20.4997 9.9105 22.589 11.9998 25.1663 11.9998C25.97 11.9998 26.7262 11.7967 27.3865 11.4389L28.8902 12.9426L30.7758 11.057L29.2721 9.5533C29.6298 8.89308 29.833 8.13685 29.833 7.33317C29.833 4.75584 27.7437 2.6665 25.1663 2.6665ZM23.1663 7.33317C23.1663 6.2286 24.0618 5.33317 25.1663 5.33317C26.2709 5.33317 27.1663 6.2286 27.1663 7.33317C27.1663 8.43774 26.2709 9.33317 25.1663 9.33317C24.0618 9.33317 23.1663 8.43774 23.1663 7.33317Z"
                        fill="#E3E2E6"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M31.1663 25.3332H29.7672C29.1417 19.0339 24.1322 14.0244 17.833 13.399V11.9998H15.1663V13.399C8.86712 14.0244 3.8576 19.0339 3.23217 25.3332H1.83301V27.9998H31.1663V25.3332ZM16.4997 15.9998C21.9392 15.9998 26.4277 20.0714 27.0838 25.3332H5.91553C6.57166 20.0714 11.0602 15.9998 16.4997 15.9998Z"
                        fill="#E3E2E6"
                      />
                    </svg>
                    <p className="text-center md:text-desktop-body-2 text-mobile-body-2 font-bold mt-4">
                    ...
                    <p className="text-center md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Accreditation with CrescentRating positions your hotel as
                      a trusted choice for Muslim travelers worldwide. Join
                      hospitality leaders committed to serving a growing global
                      market with confidence and credibility.
                    </p>
                    <Button className="mt-6 sm:max-w-[195px] w-full md:text-desktop-body-2 text-mobile-body-2 bg-primary-cr-700 hover:bg-primary-cr-800 hover:text-white font-semibold text-white md:h-[49px] h-[41px]">
              ...
              >
                <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                  <div className="flex flex-col w-full">
                    ...
                    <p className="md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Manage and register your attraction properties.
                    </p>
                  </div>
                  <div className="flex flex-col w-full justify-center items-center p-6">
                    <svg
              ...
              >
                <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                  <div className="flex flex-col w-full">
                    ...
                    <p className="md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Manage and register your shopping mall properties.
                    </p>
                  </div>
                  <div className="flex flex-col w-full justify-center items-center p-6">
                    <svg
              ...
              >
                <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                  <div className="flex flex-col w-full">
                    ...
                    <p className="md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Manage and register your MICE venue properties.
                    </p>
                  </div>
                  <div className="flex flex-col w-full justify-center items-center p-6">
                    <svg
                    ...
                    <p className="text-center md:text-desktop-body-2 text-mobile-body-2 font-bold mt-4">
                      No MICE Venues Registered Yet
                    </p>
                    <p className="text-center md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Be recognized as a preferred venue for faith-based
                      meetings and events.
                    </p>
                    <p className="text-center md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                      Register your MICE venue to demonstrate your dedication to
                      inclusivity and halal-compliant hosting for corporate and
                      group travelers.
                    </p>
                    <Button className="mt-6 sm:max-w-[220px] w-full md:text-desktop-body-2 text-mobile-body-2 bg-primary-cr-700 hover:bg-primary-cr-800 hover:text-white font-semibold text-white md:h-[49px] h-[41px]">
