                                        ...
                                        !dataRegisteredHotelUser ? (
                                            <div className="flex flex-col w-full justify-center items-center p-6">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M11.1667 5.89575C11.0152 5.90865 10.8694 5.92422 10.7296 5.94302C9.85559 6.06053 9.01779 6.32552 8.33824 7.00507C7.65869 7.68462 7.3937 8.52242 7.27619 9.39644C7.16654 10.212 7.1666 11.2304 7.16666 12.4124L7.16667 28.5002H4.5V31.1668H28.5V28.5002H25.8333L25.8333 12.4124C25.8334 11.2304 25.8335 10.212 25.7238 9.39644C25.6063 8.52242 25.3413 7.68462 24.6618 7.00507C23.9822 6.32552 23.1444 6.06053 22.2704 5.94302C21.4548 5.83337 20.4364 5.83343 19.2544 5.83349L19.1667 5.8335V3.16683H16.5V5.8335H13.8333V1.8335H11.1667V5.89575ZM23.1667 28.5002V12.5002C23.1667 11.2054 23.1638 10.3684 23.0809 9.75177C23.0032 9.17345 22.8776 8.99219 22.7761 8.89069C22.6746 8.78919 22.4934 8.66366 21.9151 8.5859C21.2984 8.50299 20.4614 8.50016 19.1667 8.50016H13.8333C12.5386 8.50016 11.7016 8.50299 11.0849 8.5859C10.5066 8.66366 10.3254 8.78919 10.2239 8.89069C10.1224 8.99219 9.99683 9.17345 9.91908 9.75177C9.83617 10.3684 9.83333 11.2054 9.83333 12.5002V28.5002H23.1667ZM13.8333 13.8335H11.1667V11.1668H13.8333V13.8335ZM21.8333 13.8335H19.1667V11.1668H21.8333V13.8335ZM11.1667 19.1668V16.5002H13.8333V19.1668H11.1667ZM15.1667 13.8335V11.1668H17.8333V13.8335H15.1667ZM15.1667 19.1668V16.5002H17.8333V19.1668H15.1667ZM19.1667 19.1668V16.5002H21.8333V19.1668H19.1667ZM11.1667 24.5002V21.8335H13.8333V24.5002H11.1667ZM15.1667 24.5002V21.8335H17.8333V24.5002H15.1667ZM19.1667 24.5002V21.8335H21.8333V24.5002H19.1667Z" fill="#E3E2E6" />
                                                </svg>
                                ...
                                <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                                    ...
                                    <div className="flex flex-col w-full justify-center items-center p-6">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M25.1663 2.6665C22.589 2.6665 20.4997 4.75584 20.4997 7.33317C20.4997 9.9105 22.589 11.9998 25.1663 11.9998C25.97 11.9998 26.7262 11.7967 27.3865 11.4389L28.8902 12.9426L30.7758 11.057L29.2721 9.5533C29.6298 8.89308 29.833 8.13685 29.833 7.33317C29.833 4.75584 27.7437 2.6665 25.1663 2.6665ZM23.1663 7.33317C23.1663 6.2286 24.0618 5.33317 25.1663 5.33317C26.2709 5.33317 27.1663 6.2286 27.1663 7.33317C27.1663 8.43774 26.2709 9.33317 25.1663 9.33317C24.0618 9.33317 23.1663 8.43774 23.1663 7.33317Z" fill="#E3E2E6" />
                                            <path fillRule="evenodd" clipRule="evenodd" d="M31.1663 25.3332H29.7672C29.1417 19.0339 24.1322 14.0244 17.833 13.399V11.9998H15.1663V13.399C8.86712 14.0244 3.8576 19.0339 3.23217 25.3332H1.83301V27.9998H31.1663V25.3332ZM16.4997 15.9998C21.9392 15.9998 26.4277 20.0714 27.0838 25.3332H5.91553C6.57166 20.0714 11.0602 15.9998 16.4997 15.9998Z" fill="#E3E2E6" />
                                        </svg>
