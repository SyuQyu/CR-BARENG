                    ...
                    <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
                        <div className="flex flex-col w-full justify-center items-center p-6">
                            ...
                            <div className="flex flex-row justify-center items-center gap-4">
                                ...
                                <Button className="mt-6 sm:min-w-[195px] w-full md:text-desktop-body-2 text-mobile-body-2 hover:text-primary-cr-800 border font-semibold text-primary-cr-700 md:h-[49px] h-[41px]">
                                    Back to Homepage
                                </Button>
                            </div>
                        </div>
