          ...
          <div className="w-full flex flex-col gap-12 md:mt-0 mt-8">
            <div className="flex flex-col w-full justify-center items-center p-6">
              ...
              <p className="text-center md:text-desktop-body-2 text-mobile-body-2 text-neutral-500">
                Your account is now active. To register your establishment and
                complete your setup, please proceed to your profile page.
              </p>
              <div className="flex flex-row justify-center items-center gap-4 mt-10">
                <Button variant="primary" className="w-[160px] py-4">
                  Go to Profile
                </Button>
                <Button variant="secondary" className="w-[160px] py-4">
                  Back to Homepage
                </Button>
              </div>
            </div>
