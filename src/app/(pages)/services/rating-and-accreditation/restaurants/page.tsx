  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(180deg, rgba(0, 0, 0, 0.40) 13.19%, rgba(0, 0, 0, 0.80) 56.41%), url('/image/rating-accreditation/restaurants.webp')",
      ...
      <div className="mt-24 w-full flex flex-col gap-24 justify-center items-center">
        <section className="w-full flex justify-center px-8 lg:px-32">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-start text-center">
              <div className="flex flex-col items-center">
                <ImageWithFallback
                  ...
                  alt={"rating-a"}
                />
                <h3 className="text-primary-cr-700 font-bold text-desktop-body-1 mt-4 mb-2">
                  Rating A
                </h3>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm text-neutral-500 leading-6 max-w-[260px]">
                  Serve only Halal food prepared in a dedicated Halal kitchen
                  using separate equipment and utensils for Halal preparation.
                  May include alcoholic beverages in the serving area.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm text-neutral-500 leading-6 max-w-[260px]">
                  Offer Halal food prepared in a dedicated Halal kitchen with
                  separate equipment and utensils for Halal preparation. May
                  include non-Halal food and alcoholic beverages in the serving
                  area.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                <ImageWithFallback
                  ...
                  className="w-full h-[150px] object-contain rounded-lg"
                  priority={false}
                  src={"/image/rating-accreditation/restaurant/cc.svg"}
                  alt={"rating-cc"}
                />
                <h3 className="text-primary-cr-700 font-bold text-desktop-body-1 mt-4 mb-2">
                  Rating CC
                ...
                <p className="text-sm text-neutral-500 leading-6 max-w-[260px]">
                  Offer Halal food prepared in a separate Halal section within
                  the main kitchen, with separate equipment and utensils for
                  Halal preparation. May include non-Halal food and alcoholic
                  beverages in the serving area.
                </p>
              </div>
            </div>
          </div>
