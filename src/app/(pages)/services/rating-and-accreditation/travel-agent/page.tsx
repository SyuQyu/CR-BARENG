import { BasicCard, Button, CrRatingBanner } from "@/components/common";
import { cardData } from "@/constants/dummyData";
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <section
        ...
        style={{
          backgroundImage:
            "url('/image/rating-accreditation/travel-agent/logo.jpg')",
