                    ...
                    <div className="grid sm:grid-cols-4 grid-cols-2 gap-6 w-full">
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            ...
                            <div className="absolute rounded-bl-lg rounded-br-lg text-center bottom-0 w-full py-[10px] border border-white/[0.01] bg-white/55 backdrop-blur-[2.4px] rounded-none">
                                <p className="text-desktop-body-2 font-semibold">Mount Fuji and Hakone</p>
                            </div>
                        </div>
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            <ImageWithFallback
                        ...
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            <ImageWithFallback
                                ...
                                className="w-full object-cover rounded-lg h-full"
                                priority={false}
                                src={"/image/rating-accreditation/activities/bali-waterfall.jpg"}
                                alt={"hotels3"}
                            />
                            <div className="absolute rounded-bl-lg rounded-br-lg text-center bottom-0 w-full py-[10px] border border-white/[0.01] bg-white/55 backdrop-blur-[2.4px] rounded-none">
                                <p className="text-desktop-body-2 font-semibold">Bali Waterfall</p>
                            </div>
                        </div>
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            <ImageWithFallback
                            ...
                            />
                            <div className="absolute rounded-bl-lg rounded-br-lg text-center bottom-0 w-full py-[10px] border border-white/[0.01] bg-white/55 backdrop-blur-[2.4px] rounded-none">
                                <p className="text-desktop-body-2 font-semibold">Taipingshan and Jiuzhize Hot Spring</p>
                            </div>
                        </div>
                    </div>
                </section>
