            ...
            <div className='mt-24 w-full flex flex-col gap-24 justify-center items-center'>
                    ...
                    <div className="grid sm:grid-cols-4 grid-cols-2 gap-6 w-full">
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            <ImageWithFallback
                                ...
                                priority={false}
                                src={"/image/rating-accreditation/activities/activity-rating-1.png"}
                                alt={"restaurant-img1"}
                            />
                        </div>
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            <ImageWithFallback
                                ...
                                className="w-full object-cover rounded-lg h-full"
                                priority={false}
                                src={"/image/rating-accreditation/activities/activity-rating-2.png"}
                                alt={"restaurant-img2"}
                            />
                        </div>
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            <ImageWithFallback
                                ...
                                className="w-full object-cover rounded-lg h-full"
                                priority={false}
                                src={"/image/rating-accreditation/activities/activity-rating-3.png"}
                                alt={"restaurant-img3"}
                            />
                        </div>
                        <div className="w-full relative lg:h-[286px] md:h-[200px] h-[150px]">
                            <ImageWithFallback
                                ...
                                className="w-full object-cover rounded-lg h-full"
                                priority={false}
                                src={"/image/rating-accreditation/activities/activity-rating-4.png"}
                                alt={"restaurant-img4"}
                            />
                        </div>
                    </div>
                ...
                <div className="max-w-[1440px] px-6 lg:px-8 w-full flex md:flex-row flex-col-reverse justify-center items-start md:gap-24 gap-12 mt-12 mb-12">
                    ...
                    <ImageWithFallback
                        ...
                        priority={false}
                        src={"/image/rating-accreditation/activities/activity-banner.png"}
                        alt={"restaurants"}
                    />
                    </div>
                </section>
