  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(180deg, rgba(0, 0, 0, 0.40) 13.19%, rgba(0, 0, 0, 0.80) 56.41%), url('/image/rating-accreditation/attractions.webp')",
        ...
        <div className="max-w-[1440px] sm:py-16 py-8 sm:px-8 lg:px-32 w-full flex sm:flex-row flex-col-reverse gap-5 ">
          <div className="flex w-full flex-col gap-5 justify-center items-center sm:mt-20 mt-10 text-white">
            <h1 className="text-mobile-heading-2 md:text-mobile-heading-2 lg:text-desktop-heading-2 font-bold bg-clip-text relative z-20 text-center w-full">
              Get Your Attraction’s Muslim Friendly services Rated
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 items-start text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-neutral-500 leading-6 max-w-[260px]">
                Establishments in this tier provide a prayer room only, suitable
                for quick visits where spiritual needs can still be fulfilled.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-neutral-500 leading-6 max-w-[260px]">
                Establishments provide key facilities such as a prayer room and
                Halal food, ensuring a comfortable visit for Muslim guests.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-neutral-500 leading-6 max-w-[260px]">
                ...
                Muslim-friendly experience, including a prayer room, Halal food
                options, ablution facilities, and water-friendly toilets.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1440px] px-8 lg:px-32 w-full flex md:gap-24 gap-12 flex-col mt-12 mb-12">
          ...
          <section className="w-full flex flex-col justify-center items-center  bg-[#F1F3FF] py-20">
            ...
            <div className="w-full max-w-[500px] flex justify-center items-center gap-10 my-12">
              <PricingCard title="Activites" price={500} />
            </div>
            <p className="sm:text-desktop-body-2 text-mobile-body-2">
