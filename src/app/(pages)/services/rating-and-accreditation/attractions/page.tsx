...
import { cardData, hotelBenefits, hotelBenefitsRestaurant, membershipTiersAttraction } from "@/constants/dummyData";
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center">
            <section
                ...
                style={{ backgroundImage: "linear-gradient(180deg, rgba(0, 0, 0, 0.40) 13.19%, rgba(0, 0, 0, 0.80) 56.41%), url('/image/rating-accreditation/attractions.webp')", backgroundSize: "cover" }}
            >
                ...
                <section className="max-w-[1440px] w-full px-6 lg:px-8 ">
                    <div className="p-5 md:p-10 w-full flex flex-col justify-center items-center bg-[#F1F3FF]">
                        ...
                        <div className="w-full max-w-[500px] flex justify-center items-center gap-10 my-12">
                            <PricingCard title="Attraction" price={500} />
                        </div>
